  ...
  const benefits = [
    {
      ...
      description: "Achieve transparency and global comparability in financial reporting through IFRS standards compliance."
    },
    {
      icon: TrendingUp,
      title: "Smooth Transition",
      description: "Seamless transition to IFRS with expert guidance on implementation and system realignment."
    },
    {
      icon: Users,
      title: "Expert Guidance",
      description: "Receive clear training and guidance from experienced IFRS advisors with deep knowledge of international standards."
    },
    {
      icon: CheckCircle,
      title: "Regulatory Compliance",
      description: "Ensure compliance with IFRS requirements and maintain alignment with updated reporting standards."
    }
  ];
    ...
    <div className="min-h-screen text-white " style={{ backgroundColor: '#231F20' }}>
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center" style={{ background: 'linear-gradient(to bottom right, #231F20, #231F20, #231F20)' }}>
        ...
        <div className={`relative z-10 text-center max-w-4xl mx-auto px-6 transform transition-all duration-1000 ${
          ...
          <h1 className="text-5xl md:text-7xl font-bold mt-16 mb-6" style={{ color: '#E76524' }}>
            IFRS Advisory
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-300 leading-relaxed">
            Adopting International Financial Reporting Standards (IFRS) is essential for businesses aiming for transparency, global comparability, and regulatory compliance. Our IFRS advisory services help your organization understand, implement, and transition smoothly to the latest standards.
          </p>
...
<section id="overview" className="relative w-full py-8 ">
            ...
            <div className="relative flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-0 min-h-[400px] lg:min-h-[550px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mb-8">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[#231F20] mb-1">Provide clear training and guidance on newly introduced IFRS standards</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: '#E76524' }}></div>
                  <div>
                    <p className="text-sm font-semibold text-[#231F20] mb-1">Help you understand the provisions relevant to your business and their financial impact</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: '#E76524' }}></div>
                  <div>
                    <p className="text-sm font-semibold text-[#231F20] mb-1">Offer advisory support either as part of an audit or independently to realign systems, processes, and reporting structures with updated standards</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: '#E76524' }}></div>
                  <div>
                    <p className="text-sm font-semibold text-[#231F20] mb-1">Assist in interpreting complex IFRS requirements and applying them effectively</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: '#E76524' }}></div>
                  <div>
                    <p className="text-sm font-semibold text-[#231F20] mb-1">Ensure a smooth transition by reviewing your current reporting framework and identifying necessary adjustments</p>
                  </div>
                </div>
              </div>
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <p className="text-[#666666] mb-8 leading-relaxed ">
        With over 12 years of experience, we deliver dependable IFRS advisory services to companies of all sizes from small businesses to multinational groups. Our industry expertise ensures compliance with IFRS standards while helping organizations achieve their operational and financial goals.
          </p>
    <button className="bg-white border cursor-pointer border-[#E76524] text-[#E76524] px-6 py-3 rounded-full font-semibold hover:bg-[#E76524] hover:text-white transition-colors">
      Contact Us
    </button>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className={`transform transition-all duration-1000 ${
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-16" style={{ color: '#E76524' }}>
              Why Choose Our IFRS Advisory Services?
            </h2>
          ...
          <div className={`transform transition-all duration-1000 ${
            ...
            <div className="bg-gradient-to-br from-gray-700 to-gray-800 rounded-2xl p-8 border border-gray-600">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-2xl font-bold mb-6" style={{ color: '#E76524' }}>Schedule Your IFRS Consultation</h3>
                  <p className="text-gray-300 mb-6 leading-relaxed">
                    Our IFRS experts will assess your requirements and provide a comprehensive IFRS advisory plan 
                    tailored to your organization's needs. Contact us today to discuss your IFRS requirements.
                  </p>
                ...
                <div className="rounded-xl p-6 backdrop-blur-sm" style={{ background: 'linear-gradient(to bottom right, rgba(231, 101, 36, 0.2), rgba(231, 101, 36, 0.2))' }}>
                  <form className="space-y-4">
                    ...
                    <textarea
                      name="message"
                      placeholder="Tell us about your IFRS requirements..."
                      rows={4}
                      className="w-full px-4 py-3 rounded-md border border-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#E76524]"
                      style={{ backgroundColor: '#231F20' }}
                      required
...
export default IFRSAdvisoryPage;
