...
const InvestigationAuditPage = () => {
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center" style={{ background: 'linear-gradient(to bottom right, #231F20, #231F20, #231F20)' }}>
        ...
        <div className={`relative z-10 text-center max-w-4xl mx-auto px-6 transform transition-all duration-1000 ${
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-300 leading-relaxed">
            Uncover discrepancies and resolve concerns related to financial irregularities and potential fraud with comprehensive investigation audit services
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="group px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg" style={{ background: 'linear-gradient(to right, #E76524, #d1551a)' }} onMouseEnter={(e) => e.currentTarget.style.background = 'linear-gradient(to right, #d1551a, #b84a15)'} onMouseLeave={(e) => e.currentTarget.style.background = 'linear-gradient(to right, #E76524, #d1551a)'}>
              <span className="flex items-center justify-center">
                Get Investigation Consultation
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <p className="text-[#666666] mb-8 leading-relaxed ">
        Our investigation audit services focus on uncovering discrepancies and resolving concerns related to financial irregularities and potential fraud. With extensive industry experience, we thoroughly examine financial records, trace inconsistencies, and evaluate the accuracy of reports to provide management with clear, reliable insights.
          </p>
      ...
      >
        <div className="block w-full h-full relative">
          <Image
            src={pic}
            alt="Investigation Audit Services"
            fill
...
<section id="overview" className="relative w-full py-8 ">
            ...
            <div className="relative flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-0 min-h-[400px] lg:min-h-[550px]">
              ...
              <div className="relative w-full lg:w-[50%] h-[300px] sm:h-[400px] lg:h-[550px] flex-shrink-0 order-1 lg:order-1">
                <div className="block w-full h-full">
                  <Image
                    src={pic}
                    alt="Investigation Audit Process"
                    fill
                    className="object-cover rounded-lg"
                    priority
                    sizes="(max-width: 1024px) 100vw, 50vw"
              ...
              <h2 className="text-3xl font-bold mb-4 text-[#E76524]">
               Our Process Includes</h2>
              
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mb-8">
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: '#E76524' }}></div>
                  <div>
                    <p className="text-sm font-semibold text-[#231F20] mb-1">Deep review of accounting and financial documents</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: '#E76524' }}></div>
                  <div>
                    <p className="text-sm font-semibold text-[#231F20] mb-1">Identifying red flags, unusual transactions, or fraudulent activity</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: '#E76524' }}></div>
                  <div>
                    <p className="text-sm font-semibold text-[#231F20] mb-1">Assessing the fairness and validity of claims or internal reports</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: '#E76524' }}></div>
                  <div>
                    <p className="text-sm font-semibold text-[#231F20] mb-1">Presenting findings with clear interpretations for decision-makers</p>
                  </div>
                </div>
              </div>
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <p className="text-[#666666] mb-8 leading-relaxed ">
        Our goal is to deliver precise and meaningful conclusions that support your organization in addressing issues effectively and strengthening internal integrity.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className={`transform transition-all duration-1000 ${
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-16" style={{ color: '#E76524' }}>
              Why Choose Our Investigation Audit Services?
            </h2>
          ...
          <div className={`transform transition-all duration-1000 ${
            ...
            <div className="bg-gradient-to-br from-gray-700 to-gray-800 rounded-2xl p-8 border border-gray-600">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-2xl font-bold mb-6" style={{ color: '#E76524' }}>Schedule Your Investigation</h3>
                  <p className="text-gray-300 mb-6 leading-relaxed">
                    Our investigation audit experts will assess your requirements and provide a comprehensive investigation plan 
                    tailored to your organization's needs. Contact us today to discuss your investigation audit requirements.
                  </p>
                ...
                <div className="rounded-xl p-6 backdrop-blur-sm" style={{ background: 'linear-gradient(to bottom right, rgba(231, 101, 36, 0.2), rgba(231, 101, 36, 0.2))' }}>
                  <form className="space-y-4">
                    ...
                    <textarea
                      name="message"
                      placeholder="Tell us about your investigation audit requirements..."
                      rows={4}
                      className="w-full px-4 py-3 rounded-md border border-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#E76524]"
                      style={{ backgroundColor: '#231F20' }}
                      required
...
export default InvestigationAuditPage;
